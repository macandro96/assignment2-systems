...
from cs336_systems.flash_attention.flash import FlashAttentionPT, FlashAttentionTriton
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    return DDPOverlapBucketed(module=module, bucket_size_mb=bucket_size_mb)
