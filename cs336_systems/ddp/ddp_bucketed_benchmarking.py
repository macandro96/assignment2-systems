...
def train(rank, world_size, backend, model_cfg, vocab_size, bucket_size_mb, return_dict):
    ...
    ddp_model = DDPOverlapBucketed(ddp_model, bucket_size_mb)
...
if __name__ == "__main__":
    ...
    mp.spawn(
        train,
        args=(args.world_size, 'nccl', args.model_cfg, args.vocab_size, args.bucket_size_mb, return_dict),
